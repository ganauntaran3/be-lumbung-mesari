...
describe('BaseRepository', () => {
    ...
    describe('findById', () => {
        it('should return a record by ID', async () => {
            const mockData = { id: '1', name: 'Test 1', created_at: new Date(), updated_at: new Date() }
    ...
    describe('create', () => {
        it('should create a new record', async () => {
            ...
            const createdData = { id: '1', name: 'New Test', created_at: new Date(), updated_at: new Date() }
    ...
    describe('updateById', () => {
        it('should update a record by ID', async () => {
            ...
            const updatedData = { id: '1', name: 'Updated Test', created_at: new Date(), updated_at: new Date() }
    ...
    describe('deleteById', () => {
        it('should delete a record by ID', async () => {
            const deletedData = { id: '1', name: 'Deleted Test', created_at: new Date(), updated_at: new Date() }
    ...
    describe('applySorting', () => {
        ...
        it('should sanitize invalid column names', () => {
            ...
            repository['applySorting'](mockQuery as any, 'name; DROP TABLE users;', 'asc')
