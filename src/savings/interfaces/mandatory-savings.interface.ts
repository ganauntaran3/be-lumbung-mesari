...
export type UpdateMandatorySavings = Partial<
    Pick<MandatorySavingsTable, 'status' | 'paid_at' | 'processed_by' | 'processed_at'>
>

export type MandatorySavingsPaginatedResponse = PaginationResult<MandatorySavingsWithUser>