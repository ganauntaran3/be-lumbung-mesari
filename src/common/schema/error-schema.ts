...
export const createErrorResponseSchema = (statusCode: number, errorType: string, exampleMessage: string) => ({
    type: 'object',
    properties: {
...
export const createGoneRequestSchema = (message = 'Resource no longer exists') =>
...
export const createInternalServerErrorSchema = (message = 'Internal server error occurred') =>
...
export const ConflictResponseSchema = createConflictSchema('Email already exists')
export const NotFoundResponseSchema = createNotFoundSchema('User not found')
export const InternalServerErrorResponseSchema = createInternalServerErrorSchema()

// Specific OTP-related schemas
export const OtpBadRequestSchemas = {
    invalidOtp: createBadRequestSchema('Invalid OTP code'),
    expiredOtp: createGoneRequestSchema('OTP has expired. Please request a new one.'),
    ...
    sessionExpired: createGoneRequestSchema('Your session has expired. Please login again to continue.')
}

// Specific Token-related schemas
export const TokenErrorSchemas = {
    invalidToken: createUnauthorizedSchema('Invalid token'),
    expiredToken: createUnauthorizedSchema('Token has expired. Please login again.'),
    sessionExpired: createUnauthorizedSchema('Your session has expired. Please login again to continue.'),
    alreadyVerified: createBadRequestSchema('OTP already verified'),
    userNotPending: createBadRequestSchema('User not in pending status')
}
