...
description: Expert developer specializing in creating new Skills for the Antigravity agent environment. Use this skill when the user asks to create, generate, or define a new skill.
---
